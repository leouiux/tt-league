...
function attachDragDrop(gn) {
  ...
  Array.from(tbody.querySelectorAll('tr')).forEach(row => {
    ...
    row.addEventListener('dragover', e => { e.preventDefault(); e.dataTransfer.dropEffect = 'move'; row.style.outline = '2px solid var(--primary)'; });
...
h2{text-align:center;font-size:${Math.min(18,Math.max(12,cellFontPt+4))}pt;font-weight:900;margin-bottom:4px;flex-shrink:0;}
