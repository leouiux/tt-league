...
window.printAllPlayers = function() {
  ...
  // A4 landscape: margin 좌우 15mm, 상하 10mm → 가용: 267mm × 190mm
  // 제목 24pt(line-height 1.1 ≈ 26.4pt) + mb 8pt = 34.4pt
  // thead 20pt → tbody 가용 ≈ 190mm×(72/25.4) - 34.4 - 20 ≈ 539 - 54 = 485pt
  const theadPt = 20;
  const rowHPt  = Math.floor(485 / rows) - 8;
...
h1 { text-align: center; font-size: 24pt; font-weight: 900; margin-bottom: 8pt; letter-spacing: -0.3px; line-height: 1.1; }
...
*{box-sizing:border-box;margin:0;padding:0;}
html,body{font-family:'Malgun Gothic',sans-serif;background:#fff;}
h2{text-align:center;font-size:18pt;font-weight:900;margin-bottom:5pt;display:flex;align-items:baseline;justify-content:center;gap:8pt;line-height:1.1;}
