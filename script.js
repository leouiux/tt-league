...
function renderHistory() {
  ...
  tbody.innerHTML = ids.map(id => {
    const d = masterData[id];
    const savedAt = d.savedAt || (d.date || '-');
    return `<tr>
      <td style="color:var(--text3);white-space:nowrap;font-size:0.82rem;">${savedAt}</td>
      <td style="font-weight:700;text-align:left;">${d.title}</td>
